...
const forceStringIds = ["62d74d0201485f2faefda41g", "62d74d0201485f2faefda41e", "62d74ceb01485f2faefda41d"];

export const stringifyId = id => id instanceof MongoID.ObjectID ? id.valueOf() : id;
export const parseId = id => forceStringIds.includes(id) && id || MongoID.idParse(id);
